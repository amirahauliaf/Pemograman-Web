<?php
require 'koneksi.php';
$edu = query("SELECT * FROM education");
    ...
    <body>
        ...
        <section id="about" class="about">
            <div class="container card">
                    ...
                    <p style="display: none;"><?php echo "Hallo, Nama saya"." ".$nama."."?>
        ...
        <section id="Education">
            <div class="container1 card">
             ...
             <!--sambungan tambah data-->
                <div class="tambah">
                    <h4><a href="input_act.php">Tambah Data</a></h4>
                </div>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="hapus.php?Jenjang_Pendidikan=<?php echo $row["Jenjang_Pendidikan"]; ?>"
